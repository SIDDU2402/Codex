...
import { useCreateProblem, useDeleteProblem } from '@/hooks/useAdmin';
...
const ContestProblemManager = ({ contestId, contestTitle, onBack }: ContestProblemManagerProps) => {
  ...
  const { data: problems, isLoading, refetch } = useContestProblems(contestId);
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">
                Problem Management {contestTitle && `- ${contestTitle}`}
              </h3>
      ...
      {showProblemForm && (
        <Card className="bg-slate-800 border-slate-700">
          ...
          <CardContent>
            <form onSubmit={handleCreateOrUpdateProblem} className="space-y-4">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardContent className="p-8 text-center">
              <div className="text-slate-400">
                ...
                <p className="text-sm">Click "Add Problem" to create your first problem for this contest</p>
              </div>
            </CardContent>
          </Card>
        )}
